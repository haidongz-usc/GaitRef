...
class GaitGLMix(BaseModel):
    ...
    def __init__(self, *args, **kargs):
        super(GaitGLMix, self).__init__(*args, **kargs)
    ...
    def build_network(self, model_cfg):
        ...
        self.Head0 = SeparateFCs(65, in_c[2], in_c[2])
        self.Bn = nn.BatchNorm1d(in_c[2])
        self.Head1 = SeparateFCs(65, in_c[2], class_num)
    ...
    def forward(self, inputs):
        ...
        pembs = self.network(pose.squeeze(1)).view(1, outs.shape[1], -1)
